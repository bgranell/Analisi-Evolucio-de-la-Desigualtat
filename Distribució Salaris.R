...
# Afegim al segon data frame l'increment de la distància entre grups 
increment <- function(x){
  x-lag(x)
}

Comparació_Increment_Absolut_CAT_TN <- mutate(Comparació_Increment_Absolut_CAT_TN, Increment_distència_amb_grup_superior_CAT = increment(Increment.Catalunya))
Comparació_Increment_Absolut_CAT_TN <- mutate(Comparació_Increment_Absolut_CAT_TN, Increment_distència_amb_grup_superior_TN = increment(Increment.Nacional))
